...
class TestPayslipBase(TransactionCase):
    def setUp(self):
        ...
        self.Version = self.env["hr.version"]  # hr.contract -> hr.version in Odoo 19
        ...
        self.richard_emp = self.env["hr.employee"].create(
            {
                "name": "Richard",
                "sex": "male",  # Odoo 19 uses 'sex' instead of 'gender'
        ...
        # I create a contract (hr.version) for "Richard"
        # In Odoo 19, hr.employee uses _inherits with hr.version
        # so the version is created automatically. We just update it.
        self.richard_contract = self.richard_emp.current_version_id
        ...
        # I create another employee Sally and update her contract
        ...
        # Update Sally's version/contract
        self.sally.current_version_id.write(
            {
